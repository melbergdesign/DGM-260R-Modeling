...
//Name: Screwdriver03.0002.ma
//Last modified: Tue, Jan 24, 2017 04:33:10 PM
//Codeset: UTF-8
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.65056402781499023 13.415579417927125 6.8822485387587546 ;
	setAttr ".r" -type "double3" -62.738352722965878 3605.3999999984762 0 ;
...
createNode mesh -n "HandleButtShape" -p "HandleButt";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode transform -n "FlatHead";
	rename -uid "27204414-2649-7D20-6F26-27A749A4B98F";
createNode mesh -n "FlatHeadShape" -p "FlatHead";
	rename -uid "FB26D85C-9A4B-6B39-53A1-59B5407DEBE6";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode polyCube -n "polyCube1";
	rename -uid "C7ECC9A3-1F48-ED1A-39A3-A8A0B2E24316";
...
connectAttr "polyCube1.out" "FlatHeadShape.i";
...
connectAttr "FlatHeadShape.iog" ":initialShadingGroup.dsm" -na;
// End of Screwdriver03.0002.ma
