...
//Name: Boat03.0001.ma
//Last modified: Tue, Jan 31, 2017 02:53:17 PM
//Codeset: UTF-8
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.0101635938466105 16.754582792185325 -4.5130509459660146 ;
	setAttr ".r" -type "double3" -31.538352729265434 1335.0000000002458 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 20.146091233422997;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 31 ".pt";
	setAttr ".pt[9]" -type "float3" 0.02253145 0.020510694 -0.0084158918 ;
	setAttr ".pt[20]" -type "float3" 0.02253145 -0.0205107 -0.0084158918 ;
	setAttr ".pt[31]" -type "float3" 0.02253145 -0.0205107 0.0084158918 ;
	setAttr ".pt[42]" -type "float3" 0.02253145 0.0205107 0.0084158918 ;
	setAttr ".pt[83]" -type "float3" 0.02253145 0.020510694 -0.00020120846 ;
	setAttr ".pt[98]" -type "float3" 0.024398161 -0.020398078 -0.0075021922 ;
	setAttr ".pt[111]" -type "float3" 0.024398161 -0.020398078 0.0075021922 ;
	setAttr ".pt[134]" -type "float3" 0.024398161 -0.010079976 -0.0075021922 ;
	setAttr ".pt[147]" -type "float3" 0.024398161 -0.010079976 0.0075021922 ;
	setAttr ".pt[170]" -type "float3" 0.025072256 -0.0038180004 -0.0071722427 ;
	setAttr ".pt[183]" -type "float3" 0.025072256 -0.0038180004 0.0071722427 ;
	setAttr ".pt[206]" -type "float3" 0.02584813 0.0021899866 -0.0067924745 ;
	setAttr ".pt[219]" -type "float3" 0.02584813 0.0021899866 0.0067924745 ;
	setAttr ".pt[242]" -type "float3" 0.02795743 0.011685397 -0.0057600397 ;
	setAttr ".pt[255]" -type "float3" 0.02795743 0.011685397 0.0057600397 ;
	setAttr ".pt[267]" -type "float3" 0.040338352 0.012000613 -4.0567957e-07 ;
	setAttr ".pt[283]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[284]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[285]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[286]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[287]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[288]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[289]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[290]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[291]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[292]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[293]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[294]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[295]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[296]" -type "float3" 0.031401914 0 0 ;
	setAttr ".pt[297]" -type "float3" 0.031401914 0 0 ;
	setAttr ".ns" 4;
...
createNode polySplitRing -n "polySplitRing8";
	rename -uid "07B7EF6D-B84B-9F40-D30D-0EAD3D0A6FFB";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 15 "e[7]" "e[17]" "e[27]" "e[37]" "e[144]" "e[172]" "e[195]" "e[244]" "e[267]" "e[316]" "e[339]" "e[388]" "e[411]" "e[460]" "e[483]";
	setAttr ".ix" -type "matrix" 60.987696607561013 0 0 0 0 8.943233453326366 0 0 0 0 18.73356696064203 0
		 -2.1482815526496776e-14 0 0 1;
	setAttr ".wt" 0.072608195245265961;
	setAttr ".re" 27;
	setAttr ".sma" 29.999999999999996;
	setAttr ".p[0]"  0 0 1;
	setAttr ".fq" yes;
createNode polyTweak -n "polyTweak10";
	rename -uid "2A036E80-A34C-2EE2-4533-76BB95392FB7";
	setAttr ".uopa" yes;
	setAttr -s 76 ".tk";
	setAttr ".tk[195]" -type "float3" -0.0042904951 0.00070257281 0.00036508217 ;
	setAttr ".tk[196]" -type "float3" -0.0041035069 0.00057169562 0.00063187286 ;
	setAttr ".tk[197]" -type "float3" -0.0034874673 0.00014051405 0.0015875296 ;
	setAttr ".tk[198]" -type "float3" -0.0026215415 -0.0002208084 0.0027420965 ;
	setAttr ".tk[199]" -type "float3" -0.001755616 -0.00042154395 0.003704235 ;
	setAttr ".tk[200]" -type "float3" -0.0013167935 -0.00052326993 0.0039961804 ;
	setAttr ".tk[201]" -type "float3" -0.00088968949 -0.00062227872 0.0039447695 ;
	setAttr ".tk[202]" -type "float3" -2.3764411e-05 -0.0007025727 0.0043296237 ;
	setAttr ".tk[203]" -type "float3" 0.00084216084 -0.00063201465 0.0040409835 ;
	setAttr ".tk[204]" -type "float3" 0.0017080872 -0.00046998431 0.0037523443 ;
	setAttr ".tk[205]" -type "float3" 0.0025740103 -0.00030795505 0.0029345236 ;
	setAttr ".tk[206]" -type "float3" 0.0034399366 9.7123208e-05 0.0016837441 ;
	setAttr ".tk[207]" -type "float3" 0.0038085934 0.00028682337 0.00099153724 ;
	setAttr ".tk[208]" -type "float3" -0.0042904951 0.00070257281 -0.00036508217 ;
	setAttr ".tk[209]" -type "float3" -0.0041035069 0.00057169562 -0.00063187286 ;
	setAttr ".tk[210]" -type "float3" -0.0034874673 0.00014051405 -0.0015875296 ;
	setAttr ".tk[211]" -type "float3" -0.0026215415 -0.0002208084 -0.0027420965 ;
	setAttr ".tk[212]" -type "float3" -0.001755616 -0.00042154395 -0.003704235 ;
	setAttr ".tk[213]" -type "float3" -0.0013167935 -0.00052326993 -0.0039961804 ;
	setAttr ".tk[214]" -type "float3" -0.00088968949 -0.00062227872 -0.0039447695 ;
	setAttr ".tk[215]" -type "float3" -2.3764411e-05 -0.0007025727 -0.0043296237 ;
	setAttr ".tk[216]" -type "float3" 0.00084216084 -0.00063201465 -0.0040409835 ;
	setAttr ".tk[217]" -type "float3" 0.0017080872 -0.00046998431 -0.0037523443 ;
	setAttr ".tk[218]" -type "float3" 0.0025740103 -0.00030795505 -0.0029345236 ;
	setAttr ".tk[219]" -type "float3" 0.0034399366 9.7123208e-05 -0.0016837441 ;
	setAttr ".tk[220]" -type "float3" 0.0038085934 0.00028682337 -0.00099153724 ;
	setAttr ".tk[221]" -type "float3" -0.0042904951 0.00070257281 8.7284498e-06 ;
	setAttr ".tk[222]" -type "float3" 0.0042904951 0.00054270547 0.00023992856 ;
	setAttr ".tk[223]" -type "float3" 0.0042904951 0.00054270547 5.736249e-06 ;
	setAttr ".tk[224]" -type "float3" 0.0040909629 0.00043212317 0.00044067891 ;
	setAttr ".tk[225]" -type "float3" 0.0040909629 0.00043212317 -0.00044067891 ;
	setAttr ".tk[226]" -type "float3" 0.0042904951 0.00054270547 -0.00023992856 ;
	setAttr ".tk[227]" -type "float3" -0.00397476 0.00048158315 0.00086164998 ;
	setAttr ".tk[228]" -type "float3" -0.0037529166 0.00032630982 0.0012507811 ;
	setAttr ".tk[229]" -type "float3" -0.00397476 0.00048158315 -0.00086164998 ;
	setAttr ".tk[230]" -type "float3" -0.0037529166 0.00032630982 -0.0012507811 ;
	setAttr ".tk[231]" -type "float3" 0.082939483 -0.013581407 -0.0070573972 ;
	setAttr ".tk[232]" -type "float3" 0.079324797 -0.011051429 -0.012214725 ;
	setAttr ".tk[233]" -type "float3" 0.067416131 -0.0027162724 -0.030688507 ;
	setAttr ".tk[234]" -type "float3" 0.050676953 0.0042684586 -0.053007387 ;
	setAttr ".tk[235]" -type "float3" 0.033937756 0.0081488565 -0.071606502 ;
	setAttr ".tk[236]" -type "float3" 0.025454924 0.010115321 -0.077250056 ;
	setAttr ".tk[237]" -type "float3" 0.017198574 0.012029267 -0.076256268 ;
	setAttr ".tk[238]" -type "float3" 0.0004593893 0.013581407 -0.083695903 ;
	setAttr ".tk[239]" -type "float3" -0.016279792 0.012217458 -0.078116149 ;
	setAttr ".tk[240]" -type "float3" -0.033018988 0.0090852706 -0.072536439 ;
	setAttr ".tk[241]" -type "float3" -0.049758162 0.0059530837 -0.056727227 ;
	setAttr ".tk[242]" -type "float3" -0.066497348 -0.0018774784 -0.032548428 ;
	setAttr ".tk[243]" -type "float3" -0.073623821 -0.0055445693 -0.019167379 ;
	setAttr ".tk[244]" -type "float3" 0.082939483 -0.013581407 0.0070573972 ;
	setAttr ".tk[245]" -type "float3" 0.079324797 -0.011051429 0.012214725 ;
	setAttr ".tk[246]" -type "float3" 0.067416131 -0.0027162724 0.030688507 ;
	setAttr ".tk[247]" -type "float3" 0.050676953 0.0042684586 0.053007387 ;
	setAttr ".tk[248]" -type "float3" 0.033937756 0.0081488565 0.071606502 ;
	setAttr ".tk[249]" -type "float3" 0.025454924 0.010115321 0.077250056 ;
	setAttr ".tk[250]" -type "float3" 0.017198574 0.012029267 0.076256268 ;
	setAttr ".tk[251]" -type "float3" 0.0004593893 0.013581407 0.083695903 ;
	setAttr ".tk[252]" -type "float3" -0.016279792 0.012217458 0.078116149 ;
	setAttr ".tk[253]" -type "float3" -0.033018988 0.0090852706 0.072536439 ;
	setAttr ".tk[254]" -type "float3" -0.049758162 0.0059530837 0.056727227 ;
	setAttr ".tk[255]" -type "float3" -0.066497348 -0.0018774784 0.032548428 ;
	setAttr ".tk[256]" -type "float3" -0.073623821 -0.0055445693 0.019167379 ;
	setAttr ".tk[257]" -type "float3" 0.082939439 -0.013581407 -0.00016872954 ;
	setAttr ".tk[258]" -type "float3" -0.082939483 -0.010491019 -0.0046380516 ;
	setAttr ".tk[259]" -type "float3" -0.082939483 -0.010491019 -0.00011088728 ;
	setAttr ".tk[260]" -type "float3" -0.079082288 -0.0083533563 -0.0085187536 ;
	setAttr ".tk[261]" -type "float3" -0.079082288 -0.0083533563 0.0085187536 ;
	setAttr ".tk[262]" -type "float3" -0.082939483 -0.010491019 0.0046380516 ;
	setAttr ".tk[263]" -type "float3" 0.07683602 -0.0093094604 -0.016656533 ;
	setAttr ".tk[264]" -type "float3" 0.072547555 -0.0063078944 -0.024178846 ;
	setAttr ".tk[265]" -type "float3" 0.07683602 -0.0093094604 0.016656533 ;
	setAttr ".tk[266]" -type "float3" 0.072547555 -0.0063078944 0.024178846 ;
createNode polySplitRing -n "polySplitRing9";
	rename -uid "0EEA6387-7347-3FDF-CA19-60B335496CE0";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 15 "e[8]" "e[18]" "e[28]" "e[38]" "e[146]" "e[174]" "e[197]" "e[246]" "e[269]" "e[318]" "e[341]" "e[390]" "e[413]" "e[462]" "e[485]";
	setAttr ".ix" -type "matrix" 60.987696607561013 0 0 0 0 8.943233453326366 0 0 0 0 18.73356696064203 0
		 -2.1482815526496776e-14 0 0 1;
	setAttr ".wt" 0.43480408191680908;
	setAttr ".re" 28;
	setAttr ".sma" 29.999999999999996;
	setAttr ".p[0]"  0 0 1;
	setAttr ".fq" yes;
createNode polyTweak -n "polyTweak11";
	rename -uid "C6F4DA15-E44F-0784-35F0-BE9244AC1169";
	setAttr ".uopa" yes;
	setAttr -s 46 ".tk";
	setAttr ".tk[7]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[9]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[18]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[20]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[29]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[31]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[40]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[42]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[81]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[83]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[96]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[98]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[109]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[111]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[132]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[134]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[145]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[147]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[168]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[170]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[181]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[183]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[204]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[206]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[217]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[219]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[240]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[242]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[253]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[255]" -type "float3" 9.3132257e-09 0 0 ;
	setAttr ".tk[267]" -type "float3" -0.017994214 0 0 ;
	setAttr ".tk[268]" -type "float3" 0.047090285 0 0 ;
	setAttr ".tk[269]" -type "float3" 0.047090285 0 0 ;
	setAttr ".tk[270]" -type "float3" 0.047090285 0 0 ;
	setAttr ".tk[271]" -type "float3" 0.047090285 0 0 ;
	setAttr ".tk[272]" -type "float3" 0.047090285 0 0 ;
	setAttr ".tk[273]" -type "float3" 0.047090285 0 0 ;
	setAttr ".tk[274]" -type "float3" 0.047090285 0 0 ;
	setAttr ".tk[275]" -type "float3" 0.047090285 0 0 ;
	setAttr ".tk[276]" -type "float3" 0.047090281 0 0 ;
	setAttr ".tk[277]" -type "float3" 0.047090281 0 0 ;
	setAttr ".tk[278]" -type "float3" 0.047090281 0 0 ;
	setAttr ".tk[279]" -type "float3" 0.047090285 0 0 ;
	setAttr ".tk[280]" -type "float3" 0.047090285 0 0 ;
	setAttr ".tk[281]" -type "float3" 0.047090285 0 0 ;
	setAttr ".tk[282]" -type "float3" 0.047090285 0 0 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
