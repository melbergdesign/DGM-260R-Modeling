...
//Name: Boat02.ma
//Last modified: Thu, Jan 26, 2017 02:53:52 PM
//Codeset: UTF-8
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -25.598318905772047 36.991545477815386 43.284393412813166 ;
	setAttr ".r" -type "double3" -36.338352729593495 1049.3999999998907 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 62.427454543284533;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "34F6BC59-7542-82C9-AC94-6EBDD6983EF2";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "34C4F4E2-C046-9D1C-77C0-C484BDEE64CF";
createNode displayLayer -n "defaultLayer";
	rename -uid "7256CED2-E04A-736F-426C-DF96DE912016";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B28D5042-0945-72D0-D19E-C0A137109E34";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "07E8D071-904F-44F3-C42F-689C0D432F16";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "217979E4-4141-6E2B-7418-7BB33A95318E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F5083F37-414D-28C1-0CB8-5491F62AF068";
