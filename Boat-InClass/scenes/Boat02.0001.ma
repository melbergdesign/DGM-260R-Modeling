...
//Name: Boat02.0001.ma
//Last modified: Thu, Jan 26, 2017 03:27:23 PM
//Codeset: UTF-8
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -31.272409493354861 22.604652086134617 18.575066671166208 ;
	setAttr ".r" -type "double3" -35.138352729503318 1381.800000000562 6.0357143969076262e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 38.351249553233394;
...
createNode polyExtrudeEdge -n "polyExtrudeEdge1";
	...
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -30.05086617792999 1.90232582740295 -9.3667833396460392 ;
	setAttr ".cbx" -type "double3" 30.38561197037885 5.0031941019918076 9.3667833396460392 ;
createNode polyExtrudeEdge -n "polyExtrudeEdge2";
	...
	setAttr ".ix" -type "matrix" 60.987696607561013 0 0 0 0 8.943233453326366 0 0 0 0 18.73356696064203 0
		 -2.1482815526496776e-14 0 0 1;
	setAttr ".ws" yes;
	setAttr ".t" -type "double3" -2.1854783949314103e-17 -2.132014218183826 0 ;
...
createNode polyExtrudeEdge -n "polyExtrudeEdge3";
	...
	setAttr ".rs" 72938047;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -26.770123273923613 -0.061360310596145932 -8.3498457129132806 ;
...
createNode polyExtrudeEdge -n "polyExtrudeEdge4";
	...
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -25.58540785528308 -1.2860744948605733 -7.9826172108381002 ;
...
createNode polyExtrudeEdge -n "polyExtrudeEdge6";
	...
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -22.506172478390241 -3.5986401700151718 -7.028143228929749 ;
	setAttr ".cbx" -type "double3" 22.840921133161931 -2.5097465463051565 7.028143228929749 ;
