...
//Name: Boat01.0004.ma
//Last modified: Tue, Jan 24, 2017 03:58:19 PM
//Codeset: UTF-8
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -57.889856743444618 22.715777900518329 5.4722026051461414 ;
	setAttr ".r" -type "double3" -21.338352729626688 995.39999999990835 -3.3796745147823103e-14 ;
...
createNode transform -s -n "front";
	...
	setAttr ".t" -type "double3" -20.787206098506317 3.5884129403599982 393.74015748031496 ;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 21 ".pt";
	setAttr ".pt[1]" -type "float3" 0 -2.3466395e-08 0 ;
	setAttr ".pt[2]" -type "float3" 0 -8.2132388e-08 0 ;
	setAttr ".pt[3]" -type "float3" 0 -2.1119756e-07 0 ;
	setAttr ".pt[4]" -type "float3" 0 -2.1119756e-07 0 ;
	setAttr ".pt[5]" -type "float3" 0 4.2239512e-07 0 ;
	setAttr ".pt[6]" -type "float3" 0 1.4079838e-07 0 ;
	setAttr ".pt[7]" -type "float3" 0 -2.1119756e-07 0 ;
	setAttr ".pt[8]" -type "float3" 0 -8.2132388e-08 0 ;
	setAttr ".pt[9]" -type "float3" 0 -2.3466395e-08 0 ;
	setAttr ".pt[34]" -type "float3" 0 -2.3466395e-08 0 ;
	setAttr ".pt[35]" -type "float3" 0 -8.2132388e-08 0 ;
	setAttr ".pt[36]" -type "float3" 0 -2.1119756e-07 0 ;
	setAttr ".pt[37]" -type "float3" 0 1.4079838e-07 0 ;
	setAttr ".pt[38]" -type "float3" 0 4.2239512e-07 0 ;
	setAttr ".pt[39]" -type "float3" 0 1.4079838e-07 0 ;
	setAttr ".pt[40]" -type "float3" 0 -2.1119756e-07 0 ;
	setAttr ".pt[41]" -type "float3" 0 -8.2132388e-08 0 ;
	setAttr ".pt[42]" -type "float3" 0 -2.3466395e-08 0 ;
	setAttr ".pt[65]" -type "float3" 0 1.4079838e-07 0 ;
	setAttr ".pt[66]" -type "float3" 0 1.4079838e-07 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7F7180FC-DF48-0179-CDA6-11A4EAD447D0";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "A0CE543C-7E4A-4C75-056B-448A6809BAD3";
createNode displayLayer -n "defaultLayer";
	rename -uid "7256CED2-E04A-736F-426C-DF96DE912016";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F0EA55E6-3349-F835-E38B-8A8C80F4E45D";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "07E8D071-904F-44F3-C42F-689C0D432F16";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A6D767FE-6C43-DAF3-ABF2-C8AC12858E7C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "CEF4956B-0144-DCBD-5D8C-6C8CC9376003";
