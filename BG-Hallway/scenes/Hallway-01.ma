...
//Name: Hallway-01.ma
//Last modified: Mon, Feb 13, 2017 11:10:01 AM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 14.47327965634668 4.7999568956656891 13.56135490329476 ;
	setAttr ".r" -type "double3" 2.0616472704154436 397.79999999994982 1.2578839878118736e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 21.227955775978881;
...
createNode transform -n "pCube1";
	...
	setAttr ".t" -type "double3" 0 3.2896144228184867 -3.5602567387498643 ;
createNode mesh -n "pCubeShape1" -p "pCube1";
	rename -uid "D94ED309-49DB-D7E7-D0D2-A2826BA7DFD6";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.5 0.0931815505027771 ;
	...
	setAttr -s 7 ".pt";
	setAttr ".pt[34]" -type "float3" 0 0 -0.61810464 ;
	setAttr ".pt[35]" -type "float3" 0 0 -0.61810464 ;
	setAttr ".pt[36]" -type "float3" 0 0 -0.61810464 ;
	setAttr ".pt[37]" -type "float3" 0 0 -0.61810464 ;
	setAttr ".pt[84]" -type "float3" 0 0 -0.61810464 ;
	setAttr ".pt[90]" -type "float3" 0 0 -0.61810464 ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "CDB6858B-49DB-8FD6-D89A-BD97AF8E9F1E";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "35B0BE07-4D16-34CC-2F8D-DE9DF9119F9F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C500A612-4DDC-2221-8104-BE847FE4B561";
createNode displayLayerManager -n "layerManager";
	rename -uid "71E54961-4DA5-FC64-8802-33BA6BB52CF9";
createNode displayLayer -n "defaultLayer";
	rename -uid "04C05009-4124-3ADE-86E6-B4A02E1CAC9B";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "8A81A070-46BD-F17E-F191-10A64BDDBFDD";
